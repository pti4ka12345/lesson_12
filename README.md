...
В текущих заданиях вы будете учиться использовать библиотеку Flask, и делать 
простыe GET-запросы. После того, как Вы выполнили  задание, попробуйте запустить фаил main.py.
